...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-chat-button-primary text-chat-button-primary-fg hover:bg-chat-button-primary/70",
        destructive:
          "bg-destructive text-destructive-fg hover:bg-destructive/90",
        outline:
          "border border-chat-input bg-background hover:bg-accent hover:text-accent-fg",
        secondary:
