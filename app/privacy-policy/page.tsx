  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      ...
      <div className="max-w-3xl text-gray-300 text-lg leading-relaxed mb-8">
        <p>
          This website does not collect any personal data from visitors. The information displayed (projects, experience, education) comes solely from my own LinkedIn and GitHub accounts, and is used exclusively for presentation purposes on this portfolio.
        </p>
        <br />
        <p>
